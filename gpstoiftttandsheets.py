...
def handleGPSmsg(GGAmsg, RMCmsg):
        ...
        port.write(('AT+HTTPPARA=\"URL\",\"maker.ifttt.com/trigger/###EVENT-NAME-HERE###/with/key/##KEY HERE##?value1=' + str(timestmp) + '&value2=' + str(latitude) + ',' + str(longitude) + '&value3=' + str(speed) $
...
def getGPSLogData():
        ...
        try:
                ...
                print('ignoring checksum error:' + msg)
        except pynmea2.nmea.ParseError:
                print('ignoring parse error:' + msg)
        except UnicodeDecodeError:
                print('ignoring unicode error:' + msg)
        finally:
                port.close()
                return ('','','')
